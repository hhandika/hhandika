...
You can call me Heru or Hez. My programming projects primarily focus on developing tools to improve the efficiency and accessibility of biodiversity reseearch. I specialize in developing high-performance, memory-efficient tools that can scale across various platforms, from personal computers and [HPC clusters](https://en.wikipedia.org/wiki/High-performance_computing) to mobile devices in the field. I'm always exploring ways to create powerful software that is both user-friendly and cost-effective to develop.
